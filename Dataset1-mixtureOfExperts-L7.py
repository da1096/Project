...
class MixtureOfExpertsCNN(nn.Module):
    def __init__(self, num_experts=3):
        ...
        # Species
        self.species_experts = nn.ModuleList([Expert(512) for _ in range(num_experts)])
        ...
        # Health
        self.health_experts = nn.ModuleList([Expert(512) for _ in range(num_experts)])
...
def main():
    ...
    # Save Model
    torch.save(model.state_dict(), 'Dataset1-mixtureOfExperts-L7.pth')
