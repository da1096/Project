...
### Architecture
architectureName = "MultiModalCNN-random"
### Number of layers
layersNum = 3
### Running info
...
class MultiTaskDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # Random Metadata
        metadata = torch.rand(2, dtype=torch.float)
...
class MultiModalCNN(nn.Module):
    def __init__(self):
        ...
        # Metadata head
        self.metadata_head = nn.Linear(256 * 1 * 1 + 128, 2) 
...
def main():
    ...
    # Save Model
    torch.save(model.state_dict(), 'Dataset1-multiModal-random-L3.pth')
