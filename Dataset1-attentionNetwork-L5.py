...
class AttentionCNN(nn.Module):
    def __init__(self):
        ...
        # Self attention
        self.self_attention = AttentionLayer(256)
        
        # Species attention
        self.species_attention = AttentionLayer(256)

        # Health attention
        self.health_attention = AttentionLayer(256)
...
def main():
    ...
    # Save Model
    torch.save(model.state_dict(), 'Dataset1-attentionNetwork-L5.pth')
