...
class CrossStitchCNN(nn.Module):
    def __init__(self):
        ...
        self.cs5 = nn.Parameter(torch.ones(256, 2, 2) * 0.5) 
    ...
    def forward(self, x):
        ...
        species_pred = self.species_head(s5)
        health_pred = self.health_head(h5)
...
def main():
    ...
    # Save Model
    torch.save(model.state_dict(), 'Dataset1-crossStitch-L5.pth')
