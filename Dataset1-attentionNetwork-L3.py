...
class AttentionCNN(nn.Module):
    def __init__(self):
        ...
        # Self attention
        self.self_attention = AttentionLayer(128)
        
        # Species attention
        self.species_attention = AttentionLayer(128)

        # Health attention
        self.health_attention = AttentionLayer(128)
    ...
    def forward(self, x):
        ...
        species_features = self.species_attention(features)
        health_features = self.health_attention(features)
...
def main():
    ...
    # Save Model
    torch.save(model.state_dict(), 'Dataset1-attentionNetwork-L3.pth')
