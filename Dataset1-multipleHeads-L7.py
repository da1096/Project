...
### Architecture
architectureName = "MultipleHeadsCNN"
### Number of layers
layersNum = 7
### Running info
...
## Multiple Heads CNN
class MultipleHeadsCNN(nn.Module):
    def __init__(self):
        super(MultipleHeadsCNN, self).__init__()
        # Shared Backbone
...
def main():
    ...
    # Save Model
    torch.save(model.state_dict(), 'Dataset1-multipleheads-L7.pth')
